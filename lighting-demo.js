...
const CURRENT_CATEGORY = "Світильники";
const ADAPTERS_CATEGORY = "Адаптери";
const AVAILABLE_LABEL = "В наявності";
const POSITIONS_LABEL = "позицій";
const CURRENCY_UAH = "грн";
const LIGHTING_PHOTO_URL = "https://drive.google.com/drive/folders/1xsfMF3q1vQ27gllevrxopFcNOdARr5ia";

const currentCategoryProducts = lightingProducts;
const allProducts = [
  ...olevsProducts,
  ...markersProducts,
  ...complectsProducts,
  ...
  card.innerHTML = `
    ...
    <div class="product-body">
      ...
      <div class="product-actions">
        ...
        <a class="ghost-note" href="${LIGHTING_PHOTO_URL}" target="_blank" rel="noreferrer">Фото</a>
      </div>
    </div>
  `;
  return card;
